...
const Contact = () => {
    ...
    const submitHandler = async (e) => {
      e.preventDefault(); 
      try {
        const response = await fetch("https://retoolapi.dev/c4PXEs/contact", {
          method: "POST",
          headers: {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-6 mb-8">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="mailto:jaruratcare@gmail.com" className="text-gray-300">jaruratcare@gmail.com</a>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="callto:+91234567991" className="text-gray-300">(555) 123-4567</a>
                </div>
              </div>
            </div>
          ...
          <form
            ...
            id="contactForm"
            className="bg-white rounded-xl p-8 animate__animated animate__fadeInRight"
          >
